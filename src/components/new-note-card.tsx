            ...
            <form onSubmit={handleSaveNote} className="flex-1 flex flex-col">              
              <div className="flex flex-1 flex-col gap-3 p-5">
                ...
                {shouldShowOnboarding ? (
                  <p className="text-sm leading-6 text-slate-400">
                    Comece <button className="font-medium text-lime-400 hover:underline outline-none focus-visible:ring-2 focus-visible:ring-lime-700 rounded-sm"> gravando uma nota</button> em áudio ou se preferir <button onClick={handleStartEditor} className="font-medium text-lime-400 hover:underline outline-none focus-visible:ring- focus-visible:ring-lime-700 rounded-sm"> utilize apenas texto</button>.
                </p>
                ) : (
                  <textarea 
                    autoFocus
